...
# Write to synapse
write.table(COMBINE, file = './DiffExpAnal_FC_Pval_Rank_Merged',sep='\t', quote=F, row.names=F)
COMBINE_OBJ <- File('./DiffExpAnal_FC_Pval_Rank_Merged', name = "Differential Expression Analysis logFC adjPval Rank", parentId = parentId)
