...
Reperform normalisation with custom design matrix (manually with "TISSUE.Dx","SEX","RACE","PMI","PlaqueMean" as fixed effects and Donor as random effects)

```{r reperform.normalisation, cache=TRUE}
# Post adjusted design matrix
DM1 = getDesignMatrix(COVARIATES[,c("TISSUE.Dx","SEX","RACE","PMI","PlaqueMean"),drop=F],Intercept = F)
