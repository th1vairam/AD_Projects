...
knitFile2Synapse(file = "./DiffExpAnal_MSSM_MA.Rmd", owner = 'syn4059381', name = "Differential Expression Analysis MSSM MA",overwrite=F)
...
# Github link
thisRepo <- getRepo(repository = "th1vairam/", ref="branch", refName='diff_exp')
...
activityName='Differential Expression Analysis of MSSM Microarray data'
  
# Code
CODE <- File(paste0('./',thisFileName), name = thisFileName, parentId = parentId)
