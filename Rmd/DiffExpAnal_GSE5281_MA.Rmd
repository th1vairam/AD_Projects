...
CONT.NAMES <- c("Region.Diseaseentorhinal_cortex_.alzheimer_s_disease_-Region.Diseaseentorhinal_cortex_.normal_",
                "Region.Diseasehippocampus_.alzheimer_s_disease_-Region.Diseasehippocampus_.normal_",
                "Region.Diseasemedial_temporal_gyrus_.alzheimer_s_disease_-Region.Diseasemedial_temporal_gyrus_.normal_",
                "Region.Diseaseposterior_singulate_.alzheimer_s_disease_-Region.Diseaseposterior_singulate_.normal_",
                "Region.Diseaseprimary_visual_cortex_.alzheimer_s_disease_-Region.Diseaseprimary_visual_cortex_.normal_",
                "Region.Diseasesuperior_frontal_gyrus_.alzheimer_s_disease_-Region.Diseasesuperior_frontal_gyrus_.normal_")
...
featureData <- fData(GSET[[1]])
FC <- cbind(featureData[rownames(DEXP$logFC),"Gene Symbol"],DEXP$logFC)
colnames(FC)[1] <- "GeneSymbol"

PVAL <- cbind(featureData[rownames(DEXP$adj.P.Val),"Gene Symbol"],DEXP$adj.P.Val)
colnames(PVAL)[1] <- "GeneSymbol"
```
